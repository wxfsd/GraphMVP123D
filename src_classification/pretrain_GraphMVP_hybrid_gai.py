...
def train_no_aug(args, device, loader, optimizer):
    ...
    for batch in l:
        ...
        if args.SSL_2D_mode == 'AM': # GraphMVP-G 模式（公式 8 中的 LGenerative 2D-SSL）对应的 AM（Attribute Masking）子任务损失项。
...
if __name__ == '__main__':
    ...
    if args.SSL_2D_mode == 'AM':  # Randomly masks an atom, and optionally masks edges connecting to it.
