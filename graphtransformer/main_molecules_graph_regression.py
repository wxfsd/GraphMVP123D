...
def main():    
    ...
    parser.add_argument('--config', default='/nfs_home/xiaofeng/zhen/GraphMVP_xf/graphtransformer/configs/molecules_GraphTransformer_LapPE_ZINC_500k_sparse_graph_BN.json', help="Please give a config.json file with training/model/data/param details")
    parser.add_argument('--gpu_id', default=8, help="Please give a value for gpu id")
